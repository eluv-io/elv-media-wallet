...
const EntitlementClaim = observer(() => {
  ...
  //const collection = marketplace.collections.find(collection => collection.sku === match.params.sku);
  //const marketplace = rootStore.marketplaces[match.params.marketplaceId];
  //rootStore.Log("EntitlementClaim " + JSON.stringify(marketplace));
